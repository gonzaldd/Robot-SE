...
/*
#define sensor_izq_blanco 700
#define sensor_izq_negro 600

#define sensor_der_blanco 600
#define sensor_der_negro 500

#define sensor_tras_blanco 500
#define sensor_tras_negro 400
*/

//Sensores en pista de madera:
/*
#define sensor_izq_blanco 300  //sensor_izq Blanco si mayor a
                                //sensor_izq Gris entre 100 y 800
#define sensor_izq_negro 100    //sensor_izq Negro si menor a

#define sensor_der_blanco 390   //sensor_der Blanco si mayor a
...
*/
#define sensor_izq_blanco 3  //sensor_izq Blanco si mayor a
                                //sensor_izq Gris entre 100 y 800
#define sensor_izq_negro 0    //sensor_izq Negro si menor a

#define sensor_der_blanco 3   //sensor_der Blanco si mayor a
                                //sensor_der Gris entre 90 y 900
#define sensor_der_negro 0     //sensor_der Negro si menor a

#define sensor_tras_blanco 2  //sensor_tras Blanco si mayor a
                                //sensor_tras Gris entre 40 y 180
#define sensor_tras_negro 0
